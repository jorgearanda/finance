...
print()
print(
    f'Day Profit:   {latest["day_profit"]:12,.2f}      ' +
    f'Month Profit: {last_month["month_profit"]:12,.2f}')
print(
    f'Day Returns:  {latest["day_returns"] * 100:12,.2f}%     ' +
    f'Month Returns:{last_month["month_returns"] * 100:12,.2f}%')
